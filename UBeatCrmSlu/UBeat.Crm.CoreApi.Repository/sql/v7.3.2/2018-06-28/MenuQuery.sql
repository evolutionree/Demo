...
BEGIN
   ...
   END IF;
   _execute_sql:='select me.menuname,me.recorder,me.menuid,me.menulanguage from crm_sys_entity_menu me LEFT JOIN  crm_sys_rule r on me.ruleid=r.ruleid where me.recstatus=1'||_sql_where||' order by me.recorder desc;';
