CREATE OR REPLACE FUNCTION "public"."crm_func_entity_field_edit"("_entityid" varchar, "_fieldid" varchar, "_fieldlabel" varchar, "_displayname" varchar, "_fieldconfig" varchar, "_fieldtype" int4, "_status" int4, "_controltype" int4, "_userno" int4, "_fieldlanguage" jsonb, "_displaylanguage" jsonb)
