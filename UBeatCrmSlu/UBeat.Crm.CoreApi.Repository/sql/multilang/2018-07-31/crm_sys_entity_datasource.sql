alter TABLE crm_sys_entity_datasource RENAME datasourcename_lang to datasrcname_lang;
...
--           END IF;
          ...
          entityid=_entityid::uuid,
					datasrcname_lang=_datasourcename_lang
...
BEGIN
   ...
   _execute_sql:='
        select e.datasrcid as datasourceid,e.datasrcname as datasourcename,e.srctype,e.srcmark,e.recstatus,e.entityid,e.isrelatepower ,e.ispro ,f.entityname,e.datasrcname_lang
