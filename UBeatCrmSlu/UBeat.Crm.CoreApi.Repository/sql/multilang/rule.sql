      ...
      IF _ruleid!='00000000-0000-0000-0000-000000000000'::uuid AND
         ...
         _ruleid!='00000000-0000-0000-0000-000000000004'::uuid THEN
						...
						WHEN 1 THEN --menu
							 ...
							 SELECT (_rulejsonobj->>'menuname_lang')::json INTO _menulanguage;
							 ...
							 UPDATE crm_sys_entity_menu SET
											 menuname=_menuname,
											 recupdator=_userno,
											 menuname_lang=_menulanguage WHERE menuid =_menuid;
    ...
    ELSE
        ...
        SELECT id,flag,msg,stacks,codes INTO 
         ...
         IF _typeid=1 THEN
           ...
           UPDATE crm_sys_entity_menu  SET menuname=(_rulejsonobj->>'menuname'), menuname_lang=(_rulejsonobj->>'menuname_lang')::jsonb, ruleid=_codeid::uuid WHERE menuid=_menuid;
         END IF;
			  _codeflag= 1;
    END IF;
