...
namespace UBeat.Crm.CoreApi.Repository.Repository.Version
{
    public class VersionRepository : RepositoryBase, IVersionRepository
    {
        ...
        public List<Dictionary<string, object>> GetUserInfoByVersion(long recVersion, int userNumber, out long maxVersion, out bool hasMoreData)
        {
            ...
            var tempTable = @"
            (SELECT u.userid,u.username,u.usericon,u.userphone,u.userjob,u.usertel,u.workcode,u.useremail,u.usersex,u.recstatus,u.recversion,u.namepinyin,ur.deptid,d.deptname,d.deptlanguage,
        ...
        {
            var selectFields = "fieldid,fieldname,entityid,fieldlabel,displayname,controltype,fieldtype,fieldconfig,recorder,recstatus,expandjs,filterjs,fieldlabel_lang,displayname_lang";
