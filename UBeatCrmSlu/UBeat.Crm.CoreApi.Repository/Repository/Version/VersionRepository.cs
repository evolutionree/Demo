...
namespace UBeat.Crm.CoreApi.Repository.Repository.Version
{
    public class VersionRepository : RepositoryBase, IVersionRepository
    {
        ...
        {
            var selectFields = "entityid,entityname,modeltype,styles,icons,relentityid,relaudit,recorder,recstatus,newload,editload,checkload,servicesjson,relfieldid,relfieldname";
