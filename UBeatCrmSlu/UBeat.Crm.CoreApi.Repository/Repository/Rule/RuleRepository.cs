...
namespace UBeat.Crm.CoreApi.Repository.Repository.Rule
{
    public class RuleRepository : RepositoryBase, IRuleRepository
    {
        ...
        {
            var executeSql = @" 
                                SELECT r.ruleid::text,r.rulename,r.entityid::text,r.recstatus,i.itemid::text,i.fieldid::text,i.itemname,i.operate,i.usetype,i.ruletype,i.ruledata,s.ruleset 
                                FROM crm_sys_rule r
