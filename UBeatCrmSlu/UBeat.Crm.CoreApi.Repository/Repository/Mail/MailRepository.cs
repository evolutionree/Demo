...
namespace UBeat.Crm.CoreApi.Repository.Repository.Mail
{
    public class MailRepository : RepositoryBase, IMailRepository
    {
        ...
        public OperateResult ReConverMails(ReConverMailMapper entity, int userId, DbTransaction dbTrans = null)
        {
            ...
            string catalogRelationSql = @"Delete From crm_sys_mail_catalog_relation Where catalogid=(select recid from crm_sys_mail_catalog where ctype=1006 and viewuserid=@userid limit 1) and  mailid=@mailid;INSERT INTO public.crm_sys_mail_catalog_relation (mailid, catalogid, relativetype) VALUES (@mailid,@catalogid,1);";
